...
scanner_light_scan_string_test_() ->
    [
     ?_assertEqual({ok,
                   ...
                   sourcer_scanner:light_scan_string(<<"a">>, latin1)),
     ?_assertEqual({ok,
                    <<?TOK_ATOM, 0:24, 0:24, 3:24>>},
                   sourcer_scanner:light_scan_string(<<"'a'">>, latin1)),
     ?_assertEqual({ok,
                    <<$(, 0:24, 0:24, 1:24>>},
                   sourcer_scanner:light_scan_string(<<"(">>, latin1)),
     ?_assertEqual({ok,
     ...
     ?_assertEqual({ok,
                   ...
                   sourcer_scanner:light_scan_string(<<"$\\b">>, latin1)),
     ?_assertEqual({ok,
                    <<?TOK_CHAR, 0:24, 0:24, 3:24>>},
                   sourcer_scanner:light_scan_string(<<"$\\n">>, latin1)),
     ?_assertEqual({ok,
                    <<?TOK_CHAR, 0:24, 0:24, 5:24>>},
                   sourcer_scanner:light_scan_string(<<"$\\122">>, latin1)),
      ?_assertEqual({ok,
                     <<?TOK_CHAR, 0:24, 0:24, 9:24>>},
                    sourcer_scanner:light_scan_string(<<"$\\x{faca}">>, latin1)),
      ?_assertEqual({ok,
                     <<?TOK_CHAR, 0:24, 0:24, 5:24>>},
                    sourcer_scanner:light_scan_string(<<"$\\xff">>, latin1)),
     ?_assertEqual({ok,
                    <<?TOK_INTEGER, 0:24, 0:24, 1:24>>},
                   sourcer_scanner:light_scan_string(<<"1">>, latin1)),
     ?_assertEqual({ok,
                    <<?TOK_FLOAT, 0:24, 0:24, 3:24>>},
                   sourcer_scanner:light_scan_string(<<"1.1">>, latin1)),
     ?_assertEqual({ok,
                    <<?TOK_FLOAT, 0:24, 0:24, 5:24>>},
                   sourcer_scanner:light_scan_string(<<"1.1e3">>, latin1)),
     ?_assertEqual({ok,
                    <<?TOK_KEYWORD, 0:24, 0:24, 3:24>>},
                   sourcer_scanner:light_scan_string(<<"end">>, latin1)),
     ?_assertEqual({ok,
     ...
     ?_assertEqual({ok,
                   ...
                   sourcer_scanner:light_scan_string(<<"?hi">>, latin1)),
     ?_assertEqual({ok,
                    <<?TOK_MACRO, 0:24, 0:24, 3:24>>},
                   sourcer_scanner:light_scan_string(<<"?HI">>, latin1)),
     ?_assertEqual({ok,
     ...
     ?_assertEqual({ok,
                    <<?TOK_COMMENT, 0:24, 0:24, 2:24,
                      ?TOK_WS, 0:24, 2:24, 1:24>>},
                   sourcer_scanner:light_scan_string(<<"%b\n">>, latin1)),
     ?_assertEqual({ok,
     ...
     ?_assertEqual({ok,
                   ...
                   sourcer_scanner:light_scan_string(<<"a() -> b.">>, latin1)),
     ?_assertEqual({ok,
                    <<?TOK_ATOM, 0:24, 0:24, 1:24,
                      $(, 0:24, 1:24, 1:24,
                      $), 0:24, 2:24, 1:24,
                   ...
                   sourcer_scanner:light_scan_string(<<"a() ->\n b.">>, latin1))
     ].
...
test_scan(S) ->
    ...
    sourcer_scanner:initial_scan(testing, "", S, "/tmp"),
    R = sourcer_scanner:get_tokens(testing),
...
test_replace(S, Pos, RemoveLength, NewText) ->
    sourcer_scanner:create(testing),
    sourcer_scanner:initial_scan(testing, "", S, "/tmp"),
    R1 = sourcer_scanner:get_tokens(testing),
    sourcer_scanner:replace_text(testing, Pos, RemoveLength, NewText),
    R2 = sourcer_scanner:get_tokens(testing),
    sourcer_scanner:dispose(testing),
    {R1, R2}.
